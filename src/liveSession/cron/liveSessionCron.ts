            ...
            if (student?.email) {
              ...
              <div style="background-color: #F9FAFB; padding: 40px 10px; font-family: sans-serif;">
                <div style="max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 30px; border: 1px solid #E5E7EB;">
                  ...
                  <p style="font-size: 15px; color: #4B5563; line-height: 1.5;">Your live session <strong>"${session.title}"</strong> by <strong>${instructorName}</strong> is starting in 10 minutes!</p>
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${session.meetingLink}" style="background-color: #4F46E5; color: white; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 8px; display: inline-block;">Go To Dashboard</a>
                  </div>
                </div>
              </div>
            `;
